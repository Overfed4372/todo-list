...
export default class ProjectsUI {
    ...
    static makeTask (task) {
        ...
        taskListDiv.setAttribute("class", "list-details");
        taskDate.setAttribute("class", "task-date");
        taskTitle.setAttribute("class", "task-title");
        taskDetails.setAttribute("class", "task-details");
        taskTitle.textContent = task.title;
        taskDetails.textContent = task.description;
        taskDate.textContent = task.dueDate === "" ? "No Due Date" : task.dueDate; 
        taskEdit.innerHTML="";
        ...
        taskListDiv.append(taskTitle);
        taskListDiv.append(taskDetails);
        taskItem.append(check);
        taskItem.append(taskListDiv);
